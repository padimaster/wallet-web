...
export function* SendTransaction() {
  ...
  try {
    ...
    let tx;
    if (tokenToSend === 'matic') {
      const sendAmount = new BigNumber(amount).times(Ether);
      const sendParams = { from: fromAddress, to: toAddress, value: sendAmount, gasPrice, gas: maxGasForEthSend, chainId: 80001 };
      ...
      const sendParams = { from: fromAddress, value: '0x0', gasPrice, gas: maxGasForTokenSend, chainId: 80001 };
